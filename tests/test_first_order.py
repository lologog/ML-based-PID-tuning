...
def test_larger_time_constant_gives_slower_response():
    fast_plant = FirstOrderPlant(gain=2.0, time_constant=1.0)
    slow_plant = FirstOrderPlant(gain=2.0, time_constant=5.0)
...
def test_larger_dt_gives_larger_first_step():
    plant_1 = FirstOrderPlant(gain=2.0, time_constant=5.0)
    plant_2 = FirstOrderPlant(gain=2.0, time_constant=5.0)
