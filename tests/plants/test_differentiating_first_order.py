...
def test_zero_gain():
    plant = DifferentiatingFirstOrderPlant(gain=0.0, time_constant=5.0)
...
def test_nan_gain():
    try:
        plant = DifferentiatingFirstOrderPlant(gain=float("nan"), time_constant=5.0)
        assert False
...
def test_positive_infinity_gain():
    try:
        plant = DifferentiatingFirstOrderPlant(gain=float("inf"), time_constant=5.0)
        assert False
...
def test_zero_time_constant():
    try:
        plant = DifferentiatingFirstOrderPlant(gain=2.0, time_constant=0.0)
        assert False
...
def test_nan_time_constant():
    try:
        plant = DifferentiatingFirstOrderPlant(gain=2.0, time_constant=float("nan"))
        assert False
...
def test_positive_infinity_time_constant():
    try:
        plant = DifferentiatingFirstOrderPlant(gain=2.0, time_constant=float("inf"))
        assert False
