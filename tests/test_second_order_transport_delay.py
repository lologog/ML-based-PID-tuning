...
def test_initial_output():
    plant = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=3.0, time_constant_2=5.0, delay=3.0)
...
def test_larger_delay_gives_slower_response():
    short_delay_plant = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=3.0, time_constant_2=5.0, delay=2.0)
    long_delay_plant = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=3.0, time_constant_2=5.0, delay=5.0)
...
def test_larger_time_constants_give_slower_response():
    fast_plant = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=1.0, time_constant_2=2.0, delay=3.0)
    slow_plant = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=3.0, time_constant_2=5.0, delay=3.0)
...
def test_larger_dt_gives_larger_first_step():
    plant_1 = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=3.0, time_constant_2=5.0, delay=3.0)
    plant_2 = SecondOrderTransportDelayPlant(gain=2.0, time_constant_1=3.0, time_constant_2=5.0, delay=3.0)
